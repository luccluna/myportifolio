<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo (isset($promocao_slides)) ? 'Editar cadastro da categoria' : 'Novo cadastro de categoria' ?></h2>
        <ol class="breadcrumb">
            <li>
                <a href="#">Loja</a>
            </li>
            ...
            <li class="active">
                <strong><?php echo (isset($promocao_slides)) ? 'Editar cadastro da categoria' : 'Novo cadastro de categoria' ?></strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2">
                            ...
                            <div class="col-sm-6 col-xs-12">
                              <div style="padding-left: 0px;" class="col-md-9">
                                ...
                                <div align="center" class="form-group">
                                    ...
                                    <input type="text" name="icone" class="form-control" value="<?php echo (isset($promocao_slides)) ? $promocao_slides->icone : '' ?>" required><i  style="    font-size: 70px;" class="fa <?php echo (isset($promocao_slides)) ? $promocao_slides->icone : '' ?>"></i></div>

                              </div><br><br>
                                <div class="col-md-3">
                                      <a data-toggle="modal" data-target="#myModal" href="javascript:void(0)">Ícones disponiveis</a>
