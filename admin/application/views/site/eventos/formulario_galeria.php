        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form action="<?php echo base_url(array('site', 'salvar-imagem')) ?>" method="post" id="form-cadastro-evento" enctype="multipart/form-data">
                        <?php if (isset($evento)): ?>
                            <input type="hidden" name="id" value="<?php echo $evento->id ?>">
                        <?php endif ?>
                           <div class="row">
                <div class="col-sm-12">
                    <label class="control-label">Imagem: * (800px X 530px)</label>
