                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-view" >
                            ...
                            <?php
                                if(!empty($pessoas)){
                                    foreach($pessoas as $area){
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $area->id ?>">
                                            <td><?php echo $area->id; ?></td>
                                            <td><?php echo $area->nome; ?> <?php echo  ($area->responsavel==1)? '<span class="respo">Responsável</span>' : '' ?></td>
                                            <td><?php echo $area->cidade; ?></td>
                                            <td><?php echo $area->email; ?></td>
                                            <td><?php echo $area->telefone; ?></td>
                                           <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(array('agenda', 'excluir')) ?>?id_area=<?php echo $id_area ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $area->id ?>" data-toggle="tooltip" data-placement="bottom" title="Desmarcar"><i class="fa fa-times"></i></a>
