                            ...
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $area->id ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(array('agenda', 'lista-pessoas')) ?>?id=<?php echo $area->id ?>&id_area=<?php echo $area->id_area; ?>" class="btn btn-default btn-icon-action" data-toggle="tooltip" data-placement="bottom" title="Pessoas"><i class="fa fa-list"></i></a>
