                ...
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        <!-- <a class="collapse-link">
                         ...
                         <a class="btn btn-primary enviar_email" href="javascript:void(0)">
                            Disparar email de noticia
                        </a> 
                    </div>
                </div>
...
<script>
        ...
        $(".enviar_email").on('click', function(){
            var $this = $(this);
            $('#modal-pedido').load('<?php echo base_url(array('site', 'modal-email')) ?>', function(){
