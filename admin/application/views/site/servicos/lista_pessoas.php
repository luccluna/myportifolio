                ...
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover dataTables-view" >
                            ...
                            <?php
                                if(!empty($pessoas)){
                                    foreach($pessoas as $servico){
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $servico->id ?>">
                                            <td><?php echo $servico->id; ?></td>
                                            <td><?php echo $servico->nome; ?> <?php echo  ($servico->responsavel==1)? '<span class="respo">Responsável</span>' : '' ?></td>
                                            <td><?php echo $servico->cidade; ?></td>
                                            <td><?php echo $servico->email; ?></td>
                                            <td><?php echo $servico->telefone; ?></td>
                                           <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(array('agenda', 'excluir')) ?>?id_servico=<?php echo $id_servico ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $servico->id ?>" data-toggle="tooltip" data-placement="bottom" title="Desmarcar"><i class="fa fa-times"></i></a>
